...
func (l CustomLayer) LayerType() gopacket.LayerType { return CustomLayerType }

// LayerContents returns the information that our layer provides.
// In this case it is a header layer so we return the header information
...
func (l CustomLayer) LayerPayload() []byte { return l.restOfData }

// decodeCustomLayer. We can name it whatever we want
...
func main() {
	...
	// some obfuscated binary data type that was difficult for others to decode.
