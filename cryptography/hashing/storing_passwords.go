...
// secretKey should be unique, protected, private  and not hard-coded like this.
// Store in environment var or in a secure configuration file.
// This is an arbitrary key that should only be used for example purposes.
var secretKey = "&nf88sn3ff3835^5"
